...
class Student():
    ...
    def write_programs(self, prog_written = 1):
        self.num_programs = prog_written + self.num_programs
...
def personal_map(func, list_input):
    new_list = []
...
programmers = [Student(student_info[0],student_info[1],student_info[2]) for student_info in student_tups_list ]
